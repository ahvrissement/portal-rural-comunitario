  ...
  return (
    <div className="min-h-screen bg-rural-gradient">
        ...
        <div className="container mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
              ...
              <span className="text-emphasis"> Serviços Governamentais</span>
            </h1>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Serviços Essenciais</h2>
            ...
            {servicos.map((servico, index) => (
              <Card key={index} className="animate-grow-in hover:shadow-lg transition-all duration-300" style={{ animationDelay: `${index * 0.1}s` }}>
                <CardHeader>
                  ...
                  <CardDescription className="text-sm mb-3">{servico.descricao}</CardDescription>
      ...
      <section className="py-16 px-4 bg-white/50">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Documentos Essenciais</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            {documentos.map((doc, index) => (
              <Card key={index} className="animate-fade-in-up" style={{ animationDelay: `${index * 0.1}s` }}>
                <CardHeader>
                  ...
                  <CardDescription className="mb-4">{doc.descricao}</CardDescription>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Precisa de Ajuda?</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="text-center animate-grow-in">
              <CardHeader>
                ...
                <CardDescription>Suporte telefônico especializado</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="text-center animate-grow-in" style={{ animationDelay: "0.1s" }}>
              <CardHeader>
                ...
                <CardDescription>Encontre o escritório mais próximo</CardDescription>
              </CardHeader>
              <CardContent>
                <Button variant="outline" className="w-full">
                  Localizar
            ...
            <Card className="text-center animate-grow-in" style={{ animationDelay: "0.2s" }}>
              <CardHeader>
                ...
                <CardDescription>Acesso unificado aos serviços</CardDescription>
              </CardHeader>
              <CardContent>
                <Button variant="outline" className="w-full">
                  <ExternalLink className="h-4 w-4 mr-2" />
            ...
            <Card className="text-center animate-grow-in" style={{ animationDelay: "0.3s" }}>
              <CardHeader>
                ...
                <CardDescription>Agende seu atendimento</CardDescription>
              </CardHeader>
              <CardContent>
                <Button variant="outline" className="w-full">
                  Agendar
      ...
      <section className="py-20 px-4 bg-field-gradient text-white">
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            <h3 className="text-3xl md:text-4xl font-bold mb-6">Simplifique o Acesso aos Seus Direitos</h3>
